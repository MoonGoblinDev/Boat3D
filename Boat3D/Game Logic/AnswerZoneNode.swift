...
// Physics Categories (ensure this is consistent with GameViewController)
// struct PhysicsCategory { // If not already globally accessible, define or import
//     static let none       = 0
//     static let boat       = 1 << 0
//     static let answerZone = 1 << 1
// }

...
struct SkyboxView: NSViewRepresentable {
    ...
    func updateNSView(_ nsView: SCNView, context: Context) {
        ...
        // If you were performing more complex SCNView specific updates,
        // you might trigger them based on `needsSceneUpdate`
        // For texture and action changes, they take effect immediately.
    }
}
